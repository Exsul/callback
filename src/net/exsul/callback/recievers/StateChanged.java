...
public class StateChanged extends BroadcastReceiver {
    ...
    static String saved_phone = "bug: deinited";
    ...
    private void SavePhone( Bundle b ) {
      if (state_monitor.Current() != TelephonyManager.EXTRA_STATE_OFFHOOK)
          return;
      saved_phone = b.getString(TelephonyManager.EXTRA_INCOMING_NUMBER);
    }

    private void CallEnded( Context context, String phone, float duration ) {
